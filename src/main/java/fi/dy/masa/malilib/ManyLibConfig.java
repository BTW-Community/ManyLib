...
public class ManyLibConfig extends SimpleConfigs {
    ...
    public static final ConfigHotkey OpenConfigMenu = new ConfigHotkey("manyLib.openMenu", "M,C", "manyLib.openMenu");
    public static final ConfigHotkey OpenModMenu = new ConfigHotkey("manyLib.openModMenu", KeybindMulti.fromStorageString("M", KeybindSettings.RELEASE), "manyLib.openModMenu");
    public static final ConfigHotkey SearchAny = new ConfigHotkey("manyLib.searchAny", "M,A", "manyLib.searchAny");
    public static final ConfigBoolean HideConfigButton = new ConfigBoolean("manyLib.hideValueButton", false, "manyLib.hideValueButton");
    public static final ConfigInteger HoverTextYLevel = new ConfigInteger("manyLib.hoverInfoY", 70, 0, 512, false, "manyLib.hoverInfoY");
    ...
    public static final ConfigBoolean AutoSaveLoad = new ConfigBoolean("manyLib.autoSaveLoad", true, "manyLib.autoSaveLoad");
